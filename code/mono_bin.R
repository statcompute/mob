...
# 01                       $X <= 86      1108    0.19      0      122   0.1101 -0.7337    0.0810   11.04
# 02             $X > 86 & $X <= 95      1081    0.19      0      166   0.1536 -0.3510    0.0205   16.88
# 03            $X > 95 & $X <= 101      1102    0.19      0      242   0.2196  0.0880    0.0015   15.18
# 04           $X > 101 & $X <= 106       743    0.13      0      177   0.2382  0.1935    0.0050   12.57
# 05           $X > 106 & $X <= 115       935    0.16      0      226   0.2417  0.2126    0.0077    8.95
# 06           $X > 115 | is.na($X)       868    0.15      1      263   0.3030  0.5229    0.0468    0.00
