...
If we are specifically interested in the detailed binning outcome of the attribute **tot_income**, then batch_bin(df, 1)$BinLst[["tot_income"]] should do the work. 
