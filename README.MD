...
The function cal_woe() takes three input parameters. The `data` parameter is a data frame with the independent variable to which the binning specification should be applied. 
