...
Download the [mob_0.2.1.tar.gz](https://github.com/statcompute/mob/blob/master/mob_0.2.1.tar.gz) file and then run:

```r
install.packages("mob_0.2.1.tar.gz", repos = NULL, type = "source")
```
