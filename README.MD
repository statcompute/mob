...
This reposity hosts a collection of R functions that would generate the monotonice binning and perform the WoE (Weight of Evidence) transformation used in consumer credit scorecard developments. 
